...
if False: #swith one or all
    ...
    sequence = [
        ...
        (2*slowerFactor,    7,      Goto(x2, y2, 1+baseHeight, 2*slowerFactor)),
        (2*slowerFactor,    8,      Goto(x2, y3, 1+baseHeight, 2*slowerFactor)),
        ...
        (4*slowerFactor,    7,      Goto(x2, y2-1, 2+baseHeight, 2*slowerFactor)),
        (4*slowerFactor,    8,      Goto(x2, y3-1, 2+baseHeight, 2*slowerFactor)),
        ...
        (6*slowerFactor,    7,      Goto(x2-1, y2-1, 2+baseHeight, 2*slowerFactor)),
        (6*slowerFactor,    8,      Goto(x2-1, y3-1, 2+baseHeight, 2*slowerFactor)),
        ...
        (8*slowerFactor,    7,      Goto(x2-1, y2, .5+baseHeight, 4*slowerFactor)),
        (8*slowerFactor,    8,      Goto(x2-1, y3, .5+baseHeight, 4*slowerFactor)),
        ...
        (12*slowerFactor,    7,      Goto(x2, y2, 1+baseHeight, 2*slowerFactor)),
        (12*slowerFactor,    8,      Goto(x2, y3, 1+baseHeight, 2*slowerFactor)),
        ...
        (14*slowerFactor,    7,      Goto(x2, y2, 1+baseHeight, 2*slowerFactor)),
        (14*slowerFactor,    8,      Goto(x2, y3, 1+baseHeight, 2*slowerFactor)),
        ...
        (16*slowerFactor,    7,      Goto(x2, y2, 1.5+baseHeight, 3*slowerFactor)),
        (16*slowerFactor,    8,      Goto(x2-1, y3+1, .5+baseHeight, 3*slowerFactor)),
        ...
        (19*slowerFactor,    7,      Goto(x0, y2, 1.5+baseHeight, 3*slowerFactor)),
        ...
        (19*slowerFactor,    8,      Goto(x2-1, y0-1, .5+baseHeight, 3*slowerFactor)),
        ...
        (22*slowerFactor,    8,      Goto(x0+1, y0-1, .5+baseHeight, 3*slowerFactor)),
        (22*slowerFactor,    7,      Goto(x0, y1, 1.5+baseHeight, 3*slowerFactor)),
        ...
        (25*slowerFactor,    8,      Goto(x0+1, y3+1, .5+baseHeight, 3*slowerFactor)),
        ...
        (25*slowerFactor,    7,      Goto(x2, y1, 1.5+baseHeight, 3*slowerFactor)),
        ...
        (28*slowerFactor,    7,      Goto(x2, y2, 1.5+baseHeight, 3*slowerFactor)),
        (28*slowerFactor,    8,      Goto(x2-1, y3+1, .5+baseHeight, 3*slowerFactor)),
        ...
        (31*slowerFactor,    7,      Goto(x2, y2, 1.5+baseHeight, 1*slowerFactor)),
        (31*slowerFactor,    8,      Goto(x2-1, y3+1, .5+baseHeight, 1*slowerFactor)),
        ...
        (32*slowerFactor,    7,      Goto(x2, y2, 1.5, 2*slowerFactor)),
        (32*slowerFactor,    8,      Goto(x2, y3, 1.5, 2*slowerFactor)),
        #Landing Step 1 move in normal formation
        ...
        (34*slowerFactor,    7,      Goto(x2, y2, 0.5, 2*slowerFactor)),
        (34*slowerFactor,    8,      Goto(x2, y3, 0.5, 2*slowerFactor)),
